...
public class PropertiesPanel extends JPanel implements ChangeListener{
    ...
    private static final int ELEVATOR_CAPACITY_MAX = 5;
    private static final int ELEVATOR_CAPACITY_MIN = 5;
    private static final String ELEVATOR_CAPACITY_NAME = "ElevatorContainer";
    private static final int ELEVATOR_CAPACITY_STEP = 1;
    private static final int PASSENGERS_NUMBER_MAX = 100;
    ...
    private static final int STORIES_NUMBER_MAX = 20;
    private static final int STORIES_NUMBER_MIN = 5;
    ...
    public PropertiesPanel(Properties properties){
        ...
        gridBagConstraints.gridx = UIDimensions.ELEVATOR_CAPACITY;
